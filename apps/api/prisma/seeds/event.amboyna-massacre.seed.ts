...
<ul>
  ...
  <li><strong>현지 VOC의 사실상 거부</strong>: 바타비아 총독 얀 피터르스존 쿤(Coen)이 "본국이 모르고 양보한 것"이라며 격분, 본국에 항의 서한 발송. 현지에서는 EIC 측에 ①관세 이중 부과 ②식량 공급 차단 ③항구 출입 제한 등으로 사실상 무력화 시도.</li>
...
<ul>
  ...
  },
  {
    ...
    sectionType: 'aftermath',
    content: `<p>암보이나 학살의 가장 결정적인 장기 유산은 ①동남아시아 식민 권역 분할(영국-인도 / 네덜란드-인도네시아) 구도의 출발점 ②EIC의 인도 본토 진출 가속화로 1757년 플라시 전투 → 1858년 인도 제국 → 1947년 인도·파키스탄 독립으로 이어지는 인도 식민사의 간접적 출발점 ③근대 국제법 사상의 한 토대(휘호 흐로티위스의 〈자유해론〉이 1609년 발표된 후 VOC의 사실상 자치 사법권을 상징하는 사건이 됨)이다.</p>
