...
const EVENT_BODY = {
  description:
    ...
    '핵심 조항은 (1)향신료 할당 — 영국 EIC가 정향·육두구의 1/3, 후추의 1/2 확보 ' +
    '(2)공동 방위 함대(fleet of defence) — 양사 각 10척씩 총 20척으로 스페인·포르투갈에 대항 ' +
    '(3)비용 분담 — 군사 작전비를 할당 비율대로 분담 ' +
    '(4)중재 위원회 — 분쟁 발생 시 반텐(Bantam) 주재 양사 합동 위원회에서 조정 ' +
    '(5)상호 자유 통상 — 양사 상관에서 자유 거래 보장이었다. ' +
    '\n\n' +
  ...
  background:
    ...
    '\n\n' +
    '제임스 1세의 의도. 잉글랜드 왕 제임스 1세는 (1)EIC의 향신료 무역 보호 (2)네덜란드와의 신교 동맹 강화 ' +
    '(3)스페인 무적함대 위협 분산을 동시에 추구. 그러나 본국 합의가 현지 VOC 사령관에 의해 ' +
...
const SECTIONS: Array<{
...
}> = [
  {
    ...
    content: `<p>1619년 영-네덜란드 방위 조약은 (1)1605년 이후 향신료 제도에서 격화된 EIC-VOC 충돌 (2)1618년 30년 전쟁 발발로 인한 신교 동맹 강화 필요성 (3)1619-05 코엔의 자카르타 함락으로 임계점에 도달한 현지 무력 충돌이라는 세 갈래의 압력이 결합한 결과였다.</p>
...
<h3>3. 양국 본국의 의도</h3>
<ul>
  <li><strong>제임스 1세의 의도</strong>: (1)EIC 향신료 무역 보호 (2)네덜란드와의 신교 동맹 강화 (3)스페인 무적함대 위협 분산을 동시에 추구. 본국 합의가 현지 VOC 사령관에 의해 무력화될 수 있다는 점을 과소평가.</li>
...
<ul>
  ...
  },
  {
    ...
    sectionType: 'process',
    content: `<p>1619년 조약의 핵심 조항은 (1)향신료 할당 (2)공동 방위 함대 (3)비용 분담 (4)중재 위원회 (5)상호 자유 통상의 5개 항목으로 구성되었다.</p>
