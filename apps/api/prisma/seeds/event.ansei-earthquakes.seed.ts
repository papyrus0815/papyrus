 ...
 * 정확히 분리되어 표시되도록).
 *
 *  (1) 1854-12-23  안세이 도카이 지진(M8.4)
 *  (2) 1854-12-24  안세이 난카이 지진(M8.4)
 *  (3) 1855-11-11  안세이 에도 지진(M7.0)
 *
 * 등록 항목:
 *  - Event(독립) × 3
...
<p>현재 와카야마현 히로가와정의 *하마구치 고료 기념관*과 *이나무라노히 박물관*이 일화를 보존·전시 중.</p>`,
  ...
  // ────────────────────────── (3) 에도 ──────────────────────────
  {
    ...
    aftermath:
      '사망자 7,000~10,000명(추정), 가옥 전파 약 14,000호. 특히 매립지인 *혼조·후카가와* 지반 액상화로 가옥 붕괴율 70%+. 막부 핵심 인물 사상으로는 (1) 미토번 출신 *후지타 도코(藤田東湖)* 등 양이파 사상가 사망, (2) 화가 *우타가와 히로시게*는 무사했으나 그의 제자·동료 다수 사망, (3) 막부 천문방 시설 일부 붕괴. 이후 1855년 12월~1856년 1월에 약 400종의 *나마즈에(鯰絵)* 풍자 판화가 폭발적 유행 — 메기(鯰)가 막부·부유 상인을 응징하고 *세상직시(世直し)*를 가져온다는 이미지로, 막부 통치 정당성에 대한 *민중적 비판 미디어*로 기능. 막부는 1855-12 *나마즈에 출판 금지령*을 내렸으나 단속이 어려웠다.',
    keywords: [
