...
const PARENT_EVENT_BODY = {
  description:
    ...
    '①상관(factory) 설치 단계(1613 수라트 → 1640 마드라스 → 1668 봄베이 → 1690 캘커타) ' +
    '②영불 패권 다툼(1746~1763 카르나틱 전쟁) ' +
    '③벵골 정복(1757 플라시) 3단계로 진행되었으며, ' +
  ...
  aftermath:
    ...
    '\n\n' +
    '【19세기 팽창 — 마이소르·마라타·시크 정복】 ①4차 마이소르 전쟁(1799) 티푸 술탄 전사로 마이소르 합병, ' +
    '②3차 마라타 전쟁(1817~1818) 페시와 정권 해체 → 인도 중부·서부 합병, ' +
    '③2차 시크 전쟁(1849) 펀잡 합병으로 1850년대까지 인도 아대륙 거의 전체가 EIC 통치 또는 ' +
...
const CHILD1_BODY = {
  ...
  background:
    ...
    '주요 동기는 ①1588년 스페인 무적함대 격파 후 대서양·인도양 항해의 군사적 자신감, ' +
    '②네덜란드의 인도양 진출(1599년 후추 가격 8배 인상)에 대한 위기감, ' +
    '③지중해 레반트 회사(1581)를 통한 우회 수입의 한계였다. ' +
...
const CHILD3_BODY = {
  description:
    ...
    '봄베이에서 캘커타로 이전하며 ①영국령 인도의 정치 수도 ②인도 동부 무역의 중심지 ③ ' +
...
const SECTIONS: Array<{
...
}> = [
  {
    ...
    content: `<p>영국 동인도회사의 인도 진출은 ①16세기 유럽 향신료 무역 구도의 변동 ②1588년 스페인 무적함대 격파 후 영국의 대양 진출 자신감 ③1599~1600년 런던 상인층의 합자회사 결성과 엘리자베스 1세 칙허라는 세 갈래의 구조적 조건이 결합된 결과였다.</p>
...
<ul>
  ...
  <li><strong>1600-12-31 엘리자베스 1세 칙허</strong>: 〈동인도와 무역하는 런던 상인 회사(Governor and Company of Merchants of London Trading into the East Indies)〉라는 정식 명칭으로 15년 독점 칙허 발급. 초기 자본금 6만 8,373파운드, 초대 총재 토머스 스마이드. 칙허 내용은 ①희망봉~마젤란 해협 사이 모든 해역 무역 독점 ②자체 군대·요새 보유 ③외교 협상·체결권 ④왕실 직할 면허로 의회 통제 외부에 존재.</li>
</ul>
...
<ul>
  ...
  },
  {
    ...
    sectionType: 'process',
    content: `<p>EIC의 인도 진출은 약 157년에 걸쳐 ①상관 설치 단계(1613~1690) ②영불 패권 다툼(1746~1763) ③벵골 정복(1757)의 3단계로 진행되었다. 17세기에는 무굴 황제의 면허 하에 평화적 통상 거점을 확장했으나, 18세기 들어 무굴 제국의 약화와 토후국들의 대두로 군사·외교 개입이 본격화되었다.</p>
...
<ul>
  ...
  },
  {
    ...
    content: `<p>EIC의 인도 진출은 ①영국 본국 — 산업혁명의 자본 축적원 ②인도 — 19세기 식민지·탈산업화·기근의 시작 ③동아시아 — 인도산 아편을 통한 청 시장 강제 개방의 도화선이라는 세 갈래의 글로벌 영향을 만들었다.</p>
...
<ul>
  ...
  <li><strong>19세기 영토 팽창</strong>: ①4차 마이소르 전쟁(1799) 티푸 술탄 전사 → 마이소르 합병, ②3차 마라타 전쟁(1817~1818) → 인도 중부·서부 합병, ③2차 시크 전쟁(1849) → 펀잡 합병. 1850년대까지 인도 아대륙 거의 전체가 EIC 통치 또는 간접 종주(princely state) 체제 하 편입.</li>
...
const BRITAIN_SIDE: BelligerentInput = {
  ...
  description:
    ...
    '6월 22일 플라시 인근 망고 숲에 도착. 군사적 우위는 ①상비 정규군의 훈련도·기율 ' +
    '②영국제 머스킷 소총·야포의 화력·정확도 ③방수 처리된 화약(우천 시에도 사격 가능) ' +
    '④사전 매수된 벵골 측 사령관 미르 자파르의 미동(내응)이었다. ' +
...
export async function seedBritishEastIndiaCompanyIndia(
  ...
  if (plasseyEvent) {
    ...
    const plasseyMilitaryBody = {
      ...
      objective:
        '【EIC 측】 ①벵골 나와브 시라지 웃 다울라 폐위와 친 EIC 미르 자파르 즉위 ' +
        '②블랙 홀 사건 보복과 캘커타 권익 회복 ' +
        '③벵골 무역 독점권 확보와 프랑스 영향력 제거(7년 전쟁 인도 전구 차원) ' +
        '④무굴 제국 약화기 인도 동부 패권 장악. ' +
        '【벵골 측】 ①EIC의 무단 캘커타 요새 강화 응징 ②벵골 자치권 보전 ' +
        '③EIC 통제 하의 무역 질서 회복. 시라지의 군사적 무경험과 귀족·상인층 반감으로 ' +
        '실질적 군사 전략은 부재했다.',
      tactics:
        '【EIC 전술】 ①망고 숲(약 800m × 300m)을 천연 엄폐물로 활용한 방어 진형. ' +
        '②영국제 머스킷 소총·6파운드 야포의 화력 우위(평균 사거리·정확도에서 인도 토속 화기를 압도). ' +
        '③방수 처리된 화약 — 정오 호우 시 벵골 측 화약이 젖었으나 영국 측은 사격 가능. ' +
        '④사전 매수된 미르 자파르 부대(약 3.8만)의 미동을 작전 전제로 전투 계획 수립. ' +
        '⑤정오 이후 미르 마단 전사로 진형이 와해되자 즉시 백병 돌격 전환. ' +
        '\n\n' +
        '【벵골 전술】 ①명목 5만의 수적 우세를 활용한 포위·포격. ' +
        '②미르 마단·모한 랄 휘하 약 1.2만의 친 시라지 부대만 실제 전투 참여. ' +
        '③프랑스 포병 50명(생프레 지휘) 운용으로 화력 일부 보강. ' +
        '④호우로 화약이 젖은 후 포격 중단, 무질서한 백병전으로 와해.',
      strategy:
        '【EIC 전략】 ①사전 외교적 무력화 — 미르 자파르·라이 두를라브·야르 라티프·자가트 세트 가문 등 ' +
        '벵골 귀족·상인층과 비밀 협약 체결로 적군 주력의 70%를 사실상 무력화. ' +
        '②3월 찬다나가르 함락으로 프랑스 측 보급·지원 차단. ' +
        '③망고 숲 정면 회전 회피하지 않고 결전 — 클라이브가 6-21 군사회의에서 ' +
      ...
      treaty:
        '【체결 조약】 ①알리나가르 조약(1757-02-09) — 플라시 전투 직전, 캘커타 권익 회복 협정. ' +
        '②플라시 전투 전후 EIC-미르 자파르 비밀 협약 — 약 230만 파운드 보상금 + 클라이브 개인 23만 파운드 사례. ' +
        '③알라하바드 조약(1765-08-12) — 부크사르 전투 후 무굴 황제 샤 알람 2세가 EIC에 ' +
        '벵골·비하르·오리사 디와니(diwani, 징세권)를 부여. 인도 동부 통치권이 사실상 EIC로 이전.',
      strategicImpact:
        '【인도 차원】 ①벵골 정복 → 1769~1770 벵골 대기근(약 1,000만 사망) → 19세기 탈산업화. ' +
        '②인도 토착 정치 질서의 결정적 약화 — 이후 마이소르(1799)·마라타(1818)·시크(1849) 정복으로 인도 아대륙 거의 전체가 EIC 통치 또는 간접 종주 체제 편입. ' +
        '③1857 세포이 항쟁 → 1858 영국 왕실 직할 전환 → 1947 독립까지의 약 190년 식민 통치 골격 형성. ' +
        '\n\n' +
        '【영국 차원】 ①벵골 부 유출 → 산업혁명 자본 축적의 핵심 원천. ' +
        '②"네이밥(Nabob)" 현상 — EIC 출신 신흥 귀족층의 영국 정치 진출. ' +
        '③1773 규제법·1784 피트의 인도법으로 EIC가 본국 정부의 위탁 통치 기구로 전환. ' +
        '\n\n' +
        '【동아시아 차원】 ①EIC가 1773 벵골·비하르 양귀비 재배 독점 → 인도산 아편의 청 밀수출. ' +
        '②1820년 4,000상자 → 1838년 4만 상자(2,400톤)로 폭증. ' +
        '③1839 임칙서의 후먼 폐기 → 1840 1차 아편전쟁 → 1842 난징 조약. ' +
