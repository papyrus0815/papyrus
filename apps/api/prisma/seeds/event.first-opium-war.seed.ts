...
const PARENT_EVENT_BODY = {
  description:
    ...
    '①홍콩 영구 할양 ②광저우·샤먼·푸저우·닝보·상하이 5개 항구 개항 ③배상금 2,100만 은량 ' +
    '④협정관세(관세 자주권 상실) ⑤공행(公行) 독점 폐지를 청에 강요했고, ' +
  ...
  aftermath:
    ...
    '①홍콩섬 영국 영구 할양 ' +
    '②광저우·샤먼·푸저우·닝보·상하이 5개항 개항 및 영국 영사 주재 허용 ' +
    '③배상금 2,100만 은량(아편 보상 600만 + 상관 채무 300만 + 전비 1,200만, 4년 분할 지불) ' +
    '④협정관세 — 5% 종가세를 양국 합의로 정해 청의 관세 자주권을 사실상 박탈 ' +
    '⑤공행(公行) 독점 폐지 — 13행이 독점하던 對외무역 체제를 해체, 영국 상인 자유 거래 보장 ' +
    '⑥양국 관리 대등 외교(평등 의례 적용)였다. ' +
    '\n\n' +
...
<ul>
  <li><strong>파머스턴 외상의 강경론</strong>: 1839년 11월부터 외상 파머스턴(Lord Palmerston)이 인도총독 오클랜드와 협의해 동방원정군 편성을 주도. 명분은 ①영국 자산(아편) 침탈 보상 ②자유무역 원칙 관철 ③자국 상인 신변·재산 보호.</li>
...
<ul>
  <li><strong>추가 개항 요구의 좌절</strong>: 영국·프랑스는 5개항 개항만으로는 對청 무역 확대가 부족하다고 판단, 1854년 망하조약 12년 개정 시한을 활용해 ①추가 개항 ②공사 베이징 주재 ③아편 무역 합법화를 요구했으나 청 조정이 거부.</li>
...
const BRITAIN_SIDE: BelligerentInput = {
  ...
  description:
    ...
    '①자국 상인 신변·재산 보호 ②자유무역 원칙 관철 ③청의 "야만적 단속"에 대한 응징이었다. ' +
...
export async function seedFirstOpiumWar(
  ...
  const militaryDetailsBody = {
    ...
    objective:
      '【영국 측】 ①자유무역 원칙 관철과 아편 무역 보호 ' +
      '②청 시장의 강제 개방(공행 독점 체제 해체) ' +
      '③영국 상인의 신변·재산·치외법권 보장 ' +
      '④최혜국 대우·관세 협정 등 불평등 조약 체제 구축. ' +
      '명분은 자유무역·자국민 보호였으나 본질은 동아시아 첫 자유무역 제국주의 사례. ' +
      '【청 측】 ①아편 단속과 사회·재정 안정 ②전통적 조공·해금(海禁) 체제 유지 ' +
      '③광저우 일구통상(一口通商) 체제 보존 ④서구의 평등 외교 의례 거부와 종주권 의식 유지. ' +
      '도광제 친정의 정책 노선은 강경파(임칙서)·화의파(기선·기영) 사이를 진동했고, ' +
      '실질적 군사 대응 전략은 부재했다.',
    tactics:
      '【영국 전술】 ①현측 함포 일제 사격 — 68파운더 활강포·신형 작약 폭탄으로 ' +
      '평균 1,000야드 이상에서 청 정크선·요새를 일방적으로 타격. ' +
      '②증기선 견인·예인·정찰 — 네메시스(Nemesis)·플레게톤(Phlegethon) 등 ' +
      '동인도회사 소속 철제 외륜선 4척이 천수(淺水) 양쯔강·연안에서 풍향 무관 기동. ' +
      '③상륙 작전 — 머스킷 소총·총검·검·왕립공병의 폭파술로 요새·도시 성벽 동시 공격. ' +
      '④사포이 활용 — 영령 인도군(마드라스·벵골 사포이)을 보병 주력으로 운용해 본토군 손실 최소화. ' +
      '\n\n' +
      '【청 전술】 ①해안 요새 정적 방어 — 호문·딩하이·진해 요새의 청동 화포로 ' +
      '협수로 봉쇄. 그러나 사거리·정확도 모두 영국 함포에 절대 열세. ' +
      '②화공·매복 — 화선(火船)으로 영국 함정을 야간 공격하는 전통 전술이 다수 시도되었으나 모두 실패. ' +
      '③정크선 함대 — 풍향 의존 + 측현 1~2문 대포로 영국 호위함 상대 가능 최대 사거리 1/3 수준. ' +
      '④만주 팔기 결사항전 — 진강·차포에서 가족 자결을 동반한 결사항전이 시도되었으나 ' +
      '병력·화력 격차로 전국(戰局) 전환에는 무력. ' +
      '⑤분산 배치의 한계 — 정규군 85만이 명목상 보유였으나 광활한 영토로 분산되어 ' +
    ...
    treaty:
      ...
      '\n\n' +
      '【추가조약】 ' +
      '①후먼(虎門) 추가조약(1843-07-22, 中英五口通商章程·虎門條約附粘) — 영사재판권·최혜국 대우 부여. ' +
      '②망하(望廈) 조약(1844-07-03) — 미국과 체결, 동일 조항 + 12년 후 조약 개정권. ' +
      '③황포(黃埔) 조약(1844-10-24) — 프랑스와 체결, 동일 조항 + 천주교 포교 자유.',
    strategicImpact:
      '【동아시아 차원】 ①근대 불평등 조약 체제의 원형 — 영사재판권·최혜국 대우·협정관세·자유 통상이 ' +
      '향후 100여 년간 동아시아 외교의 표준틀로 작동. ' +
      '②조공·해금 체제의 종언 — 명대 이래 약 500년간 지속된 동아시아 국제질서가 ' +
      '서구 주권국가 체제로 전환되는 분기점. ' +
      '③일본·조선·베트남의 분기 — 일본은 위기 인식 → 메이지 유신(1868)으로, ' +
      '조선은 위정척사 → 쇄국 강화 → 1876년 강화도 조약까지 개국 지연으로, ' +
      '베트남은 쇄국 → 1858년 다낭 침공 → 1885년 프랑스 보호국화로 각각 분기. ' +
      '\n\n' +
      '【청 내부 차원】 ①배상금 부담 → 가렴주구 → 농민 반란 → 태평천국의 난(1851~1864, 사망 약 2,000만~7,000만). ' +
      '②양무 사상의 맹아 — 위원의 〈해국도지〉(1843), "사이장기이제이" 양무론 등장. ' +
      '③한족 신사층의 부상 — 태평천국 진압 과정에서 증국번·이홍장 등 한족 군사 지도자가 부상, ' +
      '만주 정권의 한족 의존이 본격화. ' +
      '\n\n' +
      '【장기 영향】 ①홍콩 식민지 형성과 1997년 반환까지 155년 지속. ' +
      '②"굴욕의 세기(百年國恥)" 시작 — 1949년 신중국 수립까지 100여 년에 걸친 외세 침탈 시발점. ' +
      '③오늘날 중국 외교 담론의 핵심 정체성 — 시진핑 시대 "중화민족 위대한 부흥(中華民族偉大復興)" ' +
