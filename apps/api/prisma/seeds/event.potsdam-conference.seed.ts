 ...
 *  - 결과물 두 갈래: ① 7월 26일 *포츠담 선언*(미·영·중 공동 명의로 일본에
 *    무조건 항복 요구), ② 8월 2일 *포츠담 협정/공동성명*(독일 점령 4분할,
  ...
  if (event) {
    ...
    event = await prisma.event.create({
      data: {
        ...
        background:
          '1945년 2월 4~11일 얄타 회담에서 미·영·소 3국은 ① 독일 항복 후 4분할 점령(프랑스 추가), ② 폴란드 임시정부 구성, ③ 소련의 대일 참전(독일 항복 3개월 후), ④ 유엔 창설 일정에 합의했다. 그러나 ① 1945-04-12 루스벨트 사망으로 트루먼 대통령 승계, ② 5월 8일 독일 무조건 항복, ③ 폴란드 루블린 정부 수립을 둘러싼 미·영-소 마찰, ④ 6월 26일 샌프란시스코 유엔헌장 서명, ⑤ 7월 16일 트리니티 핵실험 성공이라는 5개 변수가 회담 직전에 발생했다. 회담 의제는 6월 미·영·소 외교 채널을 통해 *조정안 16개 항목*으로 사전 확정되었고, 핵심은 *독일 처리·폴란드 국경·일본 항복 처리·전범 처벌·소련 대일 참전 시기* 였다. 영국 측에서는 7월 5일 시행된 총선 결과를 7월 25일 발표 예정이라는 정치 일정 때문에, 처칠이 *"승부 결과를 모른 채"* 회담을 시작해야 하는 이례적 상황이 빚어졌다.',
        aftermath:
          '회담 종료 후 즉시 가동된 *4가지 후속 절차*: ① 포츠담 선언을 일본에 통보(7-26 17:00 워싱턴 발표 + 라디오 송출, 일본 측은 7-28 스즈키 간타로 총리의 *"묵살(黙殺)"* 답변으로 거부 의사 표시) → 8-6 히로시마·8-9 나가사키 원폭 → 8-14 일본 항복 수락. ② 독일 점령 4분할 본격 가동 — 8월부터 베를린·각 지방에서 미·영·프·소 군정 발효. ③ 외상이사회(Council of Foreign Ministers, CFM) 9월 11일 런던 1차 회의로 시작되어 1945-1947년 4차 회의 동안 평화조약·국경 정리. ④ 오데르-나이세 선 적용으로 1947년까지 약 1,200~1,400만 독일계 인구가 폴란드·체코슬로바키아·헝가리 등에서 *추방(Vertreibung)*. 회담 자체는 *"미·영·소 협조의 마지막 순간"* 으로 평가되며, 트루먼-스탈린 7-24 원폭 통보 → 처칠의 풀턴 연설(1946-03-05) → 트루먼 독트린(1947-03-12) → 마셜 플랜(1947-06-05) → 베를린 봉쇄(1948-06)로 이어지는 냉전 격화의 출발점이 되었다.',
        keywords: [
...
<p>이 6개 변수의 배치는 매우 미묘하다. 트루먼의 *대소 강경 잠재* + 핵 카드 + 처칠의 정치적 운명 = *얄타 합의의 미·영 측 재해석 가능성*이 회담 시점에 활짝 열렸다. 반면 소련은 ① 폴란드 임시정부 안착, ② 동유럽 적군 진주 완료, ③ 대일 참전 카드의 시간 압박이라는 *"이미 굳어진 사실(faits accomplis)"*을 손에 쥐고 있었다. 즉, 회담은 두 진영이 서로 다른 *시간 지평*을 들고 만난 자리였다 — 미·영은 *"앞으로 6개월"*, 소련은 *"이미 굳어진 6개월"*.</p>
...
<h4>역사적 의의</h4>
<p>회담 도중 *현직 정상이 교체된 사례*는 1815년 빈 회의(나폴레옹의 100일 천하)·1932년 로잔 회의(독일 정부 교체)에 이어 세 번째지만, 그 셋 중 *영국처럼 회담장 자체가 바뀐 사례*는 포츠담이 유일하다. 이 사건은 ① 의회 민주주의가 *전시 정상회담의 정상화 압박*을 견뎌낼 수 있다는 증명, ② 외교의 *연속성(continuity)* 원칙이 *총리 개인보다 국가에 묶인다*는 점의 현장 시연으로 평가된다.</p>`,
    },
    {
      order: 7,
...
<ul>
  <li>설립 목적: ① 평화 조약 작성(이탈리아·루마니아·불가리아·헝가리·핀란드, 후일 독일), ② 영토 정리, ③ 후속 의제 조정.</li>
...
<p>포츠담 회담은 17일간의 단일 사건이지만, 그 결과로 형성된 ① 냉전, ② 동아시아 점령 구조, ③ 유럽 국경, ④ 정상외교 모델은 모두 60~80년의 시계열 효과를 가진다. 이 점에서 8-2 새벽 0시 30분의 서명은 *전후 세계 질서의 출생증명서*로 평가된다.</p>`,
    },
  ]
