...
const NEW_PERSONS: PersonEntry[] = [
  {
    ...
    surname: '덜레스',
    biography:
      '미국 외교관·국무장관(재임 1953-01-26 ~ 1959-04-22). 1888년 워싱턴 D.C. 장로교 목사 가정 출생, 외조부 존 W. 포스터(국무장관, 1892-1893)·외삼촌 로버트 랜싱(국무장관, 1915-1920)의 외교 명문. 1908년 프린스턴 학사·조지워싱턴 로스쿨 졸업, 설리번앤드크롬웰 로펌 평생 근무(1911-1949 시니어 파트너). 1907년 헤이그 평화회의에서 16세에 외조부 비서로 첫 외교 경험. 1차 대전 후 베르사유 평화회의 미국 대표단 법률고문, 1945년 샌프란시스코 UN 창립회의 미국 대표단원. 1949-07 ~ 1949-11 듀이 뉴욕 주지사 임명으로 임시 상원의원. 1950-04 트루먼이 *대일 강화 특사*로 임명, 1950-06 ~ 1951-09 *덜레스 미션*으로 영국·호주·뉴질랜드·필리핀·인도 등 14개국 셔틀 외교. *"징벌적이지 않은(non-punitive) 강화"* 설계로 (1) 일본의 빠른 주권 회복, (2) 미·일 안보조약 동시 체결, (3) ANZUS·미·필리핀 상호방위조약 패키지를 만든 *전후 동아시아 안보 구조의 건축가*. 1951-09-08 샌프란시스코에서 미국 측 *서명자*. 1953년 아이젠하워 정부에서 국무장관으로 6년 재임, *대량 보복(massive retaliation)·도미노 이론·SEATO·바그다드 조약*의 봉쇄 정책 강경 라인을 설계. 1959-04 위암 사망.',
...
const PERSON_LINKS: PersonLink[] = [
  ...
  // ── 소련 측 ────────────────────────────────────────────────────────
  {
    ...
    note: '회의에 직접 불참, 그로미코 외무차관에 *전권* 위임. 그러나 (1) 회의 의제 설정·(2) 7개 수정안 작성·(3) 서명 거부 결정 모두 모스크바 정치국이 사전 결재. *대일 강화 = 미·일 동맹화*를 분명히 인지하고, *서명 거부 후 별도 평화 시도*를 1956-10-19 일·소 공동선언까지 끌어 갔다(영토 문제 미해결로 평화조약은 미체결 상태).',
  },
  {
    originalName: 'Andrei Gromyko (Андре́й Громы́ко)',
    role: '소련 외무차관·대표단장(서명 거부)',
    note: '소련 대표단장. 9-5 본회의에서 *7개 수정안* 발의 — (1) 중공 초청, (2) 류큐·오가사와라 일본 잔류, (3) 일본 영토 명시(쿠릴·사할린 소련 귀속), (4) 외국군 철수, (5) 일본 재무장 금지, (6) 가입국 확대, (7) 별도 회담 1년 연기. 모두 부결. 9-8 본회의에서 *"이 조약은 진정한 평화 조약이 아니다"* 격렬 항의 후 체코·폴란드 대표와 함께 *서명 거부* — 소련·체코·폴란드 3국이 미서명. 9-9 모스크바 귀국, 별도 *"적대적 단독 강화 비난"* 외교 캠페인 주도.',
  },
]
