 ...
 *    (1) 일본 점령의 미국 단독 통제, (2) 동아시아 무장해제 분담선(38선·16도선
 *    포함), (3) SCAP의 군사·민정 통합 권한 구조가 모두 확정되었다.
 *
 * 등록 항목
...
<ul>
  <li>(1) 일본 정부의 형식적 존속 — *간접 통치(indirect rule)* 모델.</li>
  <li>(2) 천황제 보존 가능성 — 항복 수락의 정치적 비용 절감.</li>
  <li>(3) 군사·민정 권한의 일원화 — 군정 사령관과 정치 고문의 분리는 운영 비효율.</li>
  <li>(4) 점령 비용의 일본 부담 — 미군 군표(Military Yen) 발행.</li>
  <li>(5) 농지개혁·재벌해체·교육개혁 등 *구조 개혁 동시 추진*.</li>
  <li>(6) 신헌법 제정 — 군국주의 재발 방지 장치.</li>
  <li>(7) 천황의 인격 처리는 *"점령 효율 우선"*으로 접근.</li>
</ul>
...
<ul>
  <li><strong>제1부 — 궁극적 목적</strong>: (1) 일본의 미국 안보에 대한 위협 제거, (2) 평화·책임·국제법 준수 정부의 수립.</li>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>19:00</strong></td><td><strong>트루먼이 백악관 라디오 마이크 앞에서 다음을 발표</strong>:<br/>(1) 일본 정부의 포츠담 선언 수락 사실, (2) 적대 행위 즉시 중지 명령, (3) "더글러스 맥아더 육군 원수를 일본의 항복을 받고 점령 통치를 수행할 연합군 최고사령관(Supreme Commander for the Allied Powers)으로 임명한다"는 발표.</td></tr>
...
<p>스탈린의 명분은 두 가지였다. (1) 1941년 일소 중립조약을 일방 파기당한 손해배상 성격, (2) 만주·사할린·쿠릴에서 소련군이 8월 9일 이후 진격해 *수십만의 희생*을 치른 군사적 기여. 이는 단순한 외교 술수가 아니라, 실제로 8월 18일 시점 소련군이 사할린 남부를 거의 점령하고 쿠릴 열도 슘슈 섬에 상륙한 군사적 사실에 기반했다.</p>
...
<ul>
  <li>General Order No.1의 인도차이나 16도선은 *영국(이남)·중국(이북)*의 일본군 무장해제 분담선으로 시작되었으나, (1) 영국의 프랑스 식민통치 회복 지원, (2) 중국 국민정부의 호치민 정부 묵인이 겹쳐 1946-09 하이퐁 사건 → 1차 인도차이나 전쟁 발발.</li>
...
<p>1945-08-14는 단일 인사 결정이지만, 그 결정의 후속 효과는 동아시아 70년의 정치 지형 — 일본의 단일 회복, 한반도 분단, 인도차이나 전쟁, 미국 동아시아 패권 구조 — 의 *공통 출발점*으로 평가된다. 이 점에서 8월 14일은 *전후 동아시아의 1일차*다.</p>`,
  ...
  const RELATIONS: RelInput[] = [
    ...
    },
    {
      ...
      roleDescription: '연합국 일원이나 분쟁 측. 스탈린이 8월 16·22일 서한으로 (1) 홋카이도 북부 분할, (2) 부사령관 임명 요구. 트루먼이 8월 18일 답신으로 모두 거부 — 일본의 미국 단독 점령 확정.',
    },
    {
      countryName: '중국',
      role: EventCountryRole.PARTICIPANT,
  ...
  const personLinks: { originalName: string; role: string; note: string }[] = [
    ...
    },
    {
      ...
      note: '8월 16일 서한으로 (1) 홋카이도 북부 분할 점령, (2) SCAP 부사령관 임명 요구. 트루먼이 8월 18일 거부하자 8월 22일 *쿠릴 4도 단독 점령 통보*로 대응 — 북방 4도 분쟁의 시발점.',
    },
    {
