...
const ENTRIES: HistoricalCountryEntry[] = [
  ...
  {
    name: '게피드 왕국',
    enName: 'Kingdom of the Gepids',
    nameOrigin:
      '동게르만계 게피드족의 이름에서 왔다. 요르다네스는 고트족 이주 때 뒤처진 무리를 "느림보(gepanta)"라 ' +
      '부른 데서 나왔다는 민간어원을 전하지만, 학계에서는 후대의 말놀이로 본다. 영어로는 Gepids, 라틴어로는 Gepidae.',
    description:
      '3세기부터 티서강 상류와 트란실바니아 일대에 자리 잡은 동게르만계 게피드족이 세운 왕국. ' +
      '5세기 전반 훈족의 지배를 받았으나, 454년 왕 아르다리크가 네다오 전투에서 아틸라의 아들들을 격파하고 ' +
      '훈 제국을 무너뜨리며 다키아와 티서강 동쪽 평원의 패자가 되었다. ' +
      '동고트족이 이탈리아로 떠난 뒤 판노니아로 세력을 넓혔고, 530년대 후반에는 동로마의 옛 거점 시르미움' +
      '(현 세르비아 스렘스카미트로비차)을 차지해 왕도로 삼았다. 이후 랑고바르드족과 판노니아 패권을 다투었으며, ' +
      '567년 쿠니문드 왕이 랑고바르드 왕 알보인과 아바르 칸 바얀의 연합군에 패해 전사하면서 멸망했다. ' +
      '영토 대부분은 아바르 칸국에 넘어갔고, 시르미움은 잠시 동로마가 회복했다.',
    startEra: 'AD', startYear: 454,
    endEra: 'AD', endYear: 567,
    stateType: HistoricalStateType.KINGDOM,
    entityKind: HistoricalEntityKind.STATE,
    latitude: 44.97, longitude: 19.61,
    // 트란실바니아·크리샤나(창건기부터 정주핵)=RO, 티서강 상류·동부 대평원=HU,
    // 시르미움(536년경~567 왕도 — 수도 소재=최강의 정주핵 증거, 두클랴 AL 판례)=RS
    linkToIsoCodes: ['RO', 'HU', 'RS'],
  },
