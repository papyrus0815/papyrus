 ...
 *  - SovereignReign x4:
 *      ① 블라디슬라프 2세 보헤미아 16대 (1471-08-22 ~ 1516-03-13)
 *      ② 블라디슬라프 2세 헝가리 34대 (1490-09-18 ~ 1516-03-13)
 *      ③ 페르디난트 1세 보헤미아 18대 (1526-10-24 ~ 1564-07-25) — 기존 인물
 *      ④ 페르디난트 1세 헝가리 36대 (1526-12-16 ~ 1564-07-25) — 기존 인물
 *
...
const HUNGARY_HC_SPEC = {
  ...
  description:
    ...
    '①합스부르크 영역(서부) ②오스만 점령지(중부) ③트란실바니아 자치(동부)로 약 150년 분할되었다. ' +
