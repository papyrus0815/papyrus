 ...
 *  - SovereignReign x3:
 *      ① 이사벨 1세 — 카스티야 왕국 12대 (1474-12-13 ~ 1504-11-26, DEATH_IN_OFFICE)
 *      ② 페르난도 2세 — 아라곤 왕국 20대 (1479-01-20 ~ 1516-01-23, DEATH_IN_OFFICE)
 *      ③ 페르난도 2세 — 카스티야 왕국 공동 군주 페르난도 5세 (1474-12-13 ~ 1504-11-26, regnalNumber=NULL,
 *                       jure uxoris — 배우자 권리)
 *
...
const MARRIAGE = {
  ...
  note:
    ...
    '\n\n' +
    '【5명의 자녀】 ①이사벨(1470~1498, 포르투갈 왕비) ②후안(1478~1497, 후계자였으나 19세 요절) ' +
    '③후아나(1479~1555, 우리의 후아나 1세 — 합스부르크 결혼으로 왕가 이전) ④마리아(1482~1517, 포르투갈 왕비 — 마누엘 1세와 결혼, 펠리페 2세 외할머니) ' +
    '⑤카탈리나(1485~1536, 잉글랜드 왕비 — 헨리 8세 첫 부인, 영국 종교개혁의 도화선). ' +
    '\n\n' +
...
const ISABEL_I = {
  ...
  deathNote:
    '1504-11-26 메디나 델 캄포에서 53세 사망. 약 1년간의 건강 악화 — ①배뇨 곤란 ②복부 종양 ' +
    '③다리 부종 ④발열 반복으로 동시기 의사들이 〈수종(hidropesía)〉으로 진단. 21세기 의학사는 ' +
    '①자궁암(uterine cancer) ②울혈성 심부전 ③신부전을 복합 사인으로 평가. ' +
    '\n\n' +
  ...
  biography:
    ...
    '①후아나 측 — 포르투갈 알폰소 5세 + 프랑스 ②이사벨 측 — 남편 페르난도(아라곤) + 카스티야 귀족 다수. ' +
    ...
    '\n\n' +
    '【1492 — 결정적 한 해】 ' +
    '①1492-01-02 그라나다 함락(Granada War 종결) — 약 781년의 레콩키스타 완료, ' +
    '이베리아 반도 마지막 무어인 왕국 나스르 왕조 멸망 ②1492-03-31 알람브라 칙령(Alhambra Decree) — ' +
    '약 20만 명 유대인 추방·강제 개종(콘베르소 — Converso) ③1492-08-03 콜럼버스 신대륙 항해 후원 ' +
    '— 1492-10-12 카리브해 도착, 약 320년 스페인 신대륙 식민지의 출발 ④1492 카스티야어 첫 문법서 ' +
    ...
    '〈콘베르소(개종한 유대인)의 진정성 검증〉이었으나 실제로는 ①가톨릭 정통 강화 ②왕권 강화의 ' +
    ...
    '\n\n' +
    '【행정·사법 개혁】 ①1480 톨레도 코르테스(의회) — 카스티야 왕권 강화 ②왕실 평의회(Consejo Real) 정비 ' +
    '③산타 헤르만다드(Santa Hermandad — 왕실 경찰) 설치 ④귀족의 사적 군대·요새 약화 ⑤사법 통합 ' +
    '— 후일 합스부르크 절대왕정 행정 시스템의 직접 모델. ' +
    '\n\n' +
    '【카스티야어와 문화】 ' +
    '①1492 안토니오 데 네브리하 〈Gramática castellana〉 — 라틴어 외 첫 유럽어 문법서, 카스티야어 = 스페인어의 ' +
    '결정적 표준화 ②부르고스·세비야 등 인쇄소 발달 ③티치아노 이전 시기지만 디에고 데 라 크루스 등 ' +
    '르네상스 화풍 도입. ' +
    '\n\n' +
    '【장기 유산】 ①1469 카스티야-아라곤 동군연합 → 1715 통합 〈에스파냐 왕국〉의 사실상 시조 ' +
    '②1492 그라나다·콜럼버스로 16세기 스페인 식민제국·황금시대의 직접 출발 ③행정·사법 개혁 → 합스부르크 절대왕정 모델 ' +
    '④1503 둘째 딸 후아나의 합스부르크 결혼으로 1516 합스부르크 스페인의 출발 ⑤다섯째 딸 카탈리나 데 아라곤이 ' +
  ...
  stats: {
    ...
    administration: 92,
    notes:
      '약 30년 재위 동안 카스티야 절대왕정의 사실상 시조 — ①1474~1479 왕위 계승 전쟁 직접 지휘 ' +
      '②1480 톨레도 코르테스로 왕권 강화 ③1492 그라나다·콜럼버스·종교재판소·알람브라 칙령 동시 추진 ' +
      '④1494 교황 〈가톨릭 양왕〉 칭호 획득. 행정·정치는 동시기 유럽 군주 중 최상위, ' +
...
const FERNANDO_II = {
  ...
  deathNote:
    '1516-01-23 카스티야 마드리갈레호의 작은 농촌 저택에서 63세 사망. 약 2년간 ①배뇨 곤란 ' +
    '②복부 부종 ③거동 곤란이 누적, 1515 가을부터 결정적 악화. 사인 학술 평가는 ' +
    '①울혈성 심부전 ②통풍 ③말년 매독(syphilis) 가설(1505 재혼한 제르멘 드 푸아의 영향)이 복합. ' +
    '\n\n' +
    ...
    '\n\n' +
    '【계승】 사망으로 ①아라곤·시칠리아·나폴리·사르데냐·발렌시아·마요르카 → 딸 후아나 1세 → ' +
    '실제로는 외손자 카를 5세(=카를로스 1세)가 카스페 협약 이래 약 100년 트라스타마라 직계 계승자로 즉위 ' +
    '②카스티야 섭정직 → 추기경 시스네로스 1517-09까지 → 카를 5세 첫 스페인 방문으로 정권 이양. ' +
    '\n\n' +
  ...
  biography:
    ...
    '\n\n' +
    '【1492 — 가톨릭 양왕의 정점】 ①1492-01-02 그라나다 함락(Granada War — 페르난도 직접 지휘) ' +
    '②1492-03-31 알람브라 칙령(유대인 추방) ③1492-08-03 콜럼버스 신대륙 항해 후원 ④1494 교황 ' +
    '〈가톨릭 양왕〉 칭호 부여. 부인 이사벨 1세와의 동등 통치 정점. ' +
    '\n\n' +
    '【외교의 천재 — 마키아벨리의 모범】 ' +
    '①1494-06-07 토르데시야스 조약(Treaty of Tordesillas) — 포르투갈과 신대륙 분할(서경 46도) ' +
    '②1494~1559 약 65년 이탈리아 전쟁의 출발 — 1494 프랑스 샤를 8세의 이탈리아 침공에 대응 ' +
    '③1503 나폴리 정복(곤살로 페르난데스 데 코르도바 — "위대한 사령관(El Gran Capitán)") ' +
    '④1512 나바라 정복으로 이베리아 반도 통합 거의 완료 ⑤1495·1508 신성동맹(Holy League) 결성 ' +
    '— 프랑스 봉쇄. 마키아벨리 〈군주론(1513)〉 21장이 페르난도를 "동시기의 새로운 군주의 모범"으로 칭송. ' +
    '\n\n' +
    '【1503 신대륙 식민지 시스템】 ①Casa de Contratación(상무성, 1503-01-20 세비야 설치) — 신대륙 무역 독점 ' +
    '②엔코미엔다(encomienda) 시스템 — 식민지 노동력 강제 동원 (후일 인권 문제 직접 출발) ' +
    '③1493 교황 알렉산데르 6세의 〈Inter caetera〉 칙서로 신대륙 스페인 측 분할 인정. ' +
    '\n\n' +
    ...
    '\n\n' +
    '【장기 유산】 ①1469 카스티야-아라곤 동군연합 → 1715 〈에스파냐 왕국〉의 시조 ' +
    '②1492 그라나다·콜럼버스로 스페인 식민제국 출발 ③1503 나폴리·1512 나바라로 이베리아 반도 통합 ' +
    '④마키아벨리 〈군주론〉의 르네상스 군주 모범 ⑤외손자 카를 5세를 통한 합스부르크 스페인 시작 ' +
    '⑥다섯째 딸 카탈리나의 잉글랜드 결혼 → 후일 영국 종교개혁의 도화선.',
  influence: 88,
  stats: {
    politics: 90,
    military: 85,
    ...
    notes:
      ...
      '행정은 부인 이사벨 1세에 비해 카리스마·인기는 약했으나 ①Casa de Contratación 신대륙 무역 독점 시스템 ' +
      '②엔코미엔다 식민지 노동 시스템 ③아라곤 코르테스 정비. ' +
...
export async function seedCatholicMonarchs(prisma: PrismaService): Promise<void> {
  ...
  // ③ 페르난도 2세 — 카스티야 공동 군주 페르난도 5세 (regnalNumber=NULL, jure uxoris)
