...
const PARENTS = [
  {
    ...
    deathNote:
      ...
      '(1)짧은 잠복기·급격한 진행 (2)장모 페르난도 2세와의 정치적 갈등 (3)장모가 직전에 부르고스 인근에 체류 등 ' +
      '정황으로 동시기·후대에 페르난도 2세의 독살 의혹이 제기되어 21세기까지 학술 논쟁 지속. ' +
      '그러나 2007 시신 검사에서 비소·수은 등 중금속 검출 음성, 21세기 학설의 다수는 자연사 가설 지지. ' +
      '\n\n' +
      '사후 영향. (1)28세 급사로 6세의 카를 5세가 합스부르크령 네덜란드 군주로 즉위 ' +
      '(2)후아나가 충격으로 정신 이상 악화 — 약 8개월간 시신과 동행하며 카스티야 횡단(전설) ' +
      '(3)장모 페르난도 2세가 카스티야 섭정으로 복귀, 후아나 유폐(1509 토르데시야스) ' +
      '(4)1516 페르난도 2세 사망 후 카를 5세가 모친 명의의 카스티야 왕위 계승. ' +
      '\n\n' +
    ...
    biography:
      ...
      '\n\n' +
      '6명의 자녀를 둠 — (1)엘레오노라(1498~) (2)카를 5세(1500~1558) (3)이사벨라(1501~) ' +
      '(4)페르디난트 1세(1503~1564, 후일 신성로마황제·오스트리아 합스부르크 시조) ' +
      '(5)마리아(1505~) (6)카타리나(1507~, 사후 출생). ' +
      '\n\n' +
  ...
  },
  {
    ...
    deathNote:
      ...
      '후아나의 정신 상태에 대한 진단이 다양하다 — (1)조현병 (2)양극성 정동장애 (3)강박증 ' +
      '(4)우울증 (5)정신 이상은 거의 없었고 정치적 음모로 유폐되었다는 견해까지. ' +
      '특히 (5)설은 1808 페르디난트 7세가 후아나를 "스페인 첫 번째 합법 군주"로 재평가하면서 부상했고, ' +
    ...
    biography:
      ...
      '\n\n' +
      '장기 유산. (1)후아나 유폐로 카를 5세의 카스티야 왕위가 정당화 → 합스부르크 스페인의 출발 ' +
      '(2)"광녀 후아나" 신화는 19세기 낭만주의 회화·소설(특히 프란시스코 프라디야의 1877 "광녀 후아나")에서 재조명 ' +
      '(3)20~21세기 페미니즘 사학에서 "남성 권력에 의한 여성 군주 격리"의 사례로 재해석.',
    influence: 60,
    stats: {
      politics: 35,
      military: 20,
...
export async function seedCharlesVParents(prisma: PrismaService): Promise<void> {
  ...
  //   (1) 합스부르크령 네덜란드(HC start=1482): 어머니 마리 부르고뉴 사망 직후 즉위 → 1대 (HC 첫 군주)
  //      regnalName "필리프 1세" — 네덜란드어 Filips I
  //   (2) 카스티야 왕국(HC start=1230, 페르난도 3세): 펠리페 즉위 시점에 13대 후아나 1세 다음
  ...
  if (aragonHC && kingDef) {
    joannaReigns.push({
      ...
      notes:
        ...
        '왕위 동시 상속. 그러나 (1)본인 1509-02 이래 토르데시야스 유폐 (2)부친 페르난도 2세의 유언으로 ' +
