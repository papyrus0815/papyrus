 ...
 *  - SovereignReign x3:
 *      (1) 신성로마제국 신성로마황제 20대 카를 5세 (1519-06-28 ~ 1556-02-25, ABDICATION)
 *      (2) 합스부르크령 네덜란드 공작 2대 카를 5세 (1506-09-25 ~ 1555-10-25, ABDICATION)
 *      (3) 카스티야 왕국 국왕 15대 카를로스 1세 (1516-01-23 ~ 1556-01-16, ABDICATION)
 *  - PersonCountryAffiliation x1 (합스부르크령 네덜란드 CITIZENSHIP)
 *  - PersonStats x1 (6축 능력치 — admin 평가)
 *
 * ⚠️ (3) 카스티야 왕국 HC는 person.charles-v-parents.seed에서 인라인 생성하므로
 *    parents 시드를 먼저 실행해야 (3)이 등록된다.
 */
import {
  AppointmentMethod,
  DeathType,
...
const PERSON = {
  ...
  deathNote:
    ...
    '(1)말년 말라리아(이베리아 반도 풍토병 — 4가지 열대열원충 중 P. malariae 추정) ' +
    '(2)만성 통풍(podagra — 합스부르크 가문 유전 경향) ' +
    '(3)전립선 비대증 합병증 ' +
    '(4)말년 약 2년간의 우울증 + 식욕 부진으로 인한 영양실조를 ' +
    '복합적 사인으로 평가. 단일 사인보다 다중 합병증으로 보는 것이 정확.',
  biography:
    '합스부르크 가문 — 스페인 합스부르크의 시조. 16세기 전반 유럽 정치의 결정적 인물. ' +
    '(1)신성로마황제 카를 5세(재위 1519~1556) (2)스페인 왕 카를로스 1세(재위 1516~1556 — 카스티야·아라곤·나폴리·시칠리아·사르데냐 합산) ' +
    '(3)합스부르크령 네덜란드 군주(1506~1555) (4)오스트리아 대공(1519~1521 후 동생 페르디난트에게 양도) ' +
    '(5)신대륙(아메리카) 군주(1516~1556 — 카스티야 왕관 하)를 동시 보유한 사상 최대 영토의 군주. ' +
    ...
    '(1)1521 보름스 의회(Diet of Worms) — 루터를 이단으로 단죄, 보름스 칙령(Edict of Worms) 발포 ' +
    '(2)1530 아우크스부르크 의회 — 신교 측 "아우크스부르크 신앙고백" 거부 ' +
    '(3)1546~1547 슈말칼덴 전쟁 — 신교 제후 동맹(Schmalkaldic League) 격파, 1547-04-24 뮐베르크 전투 결정적 승리 ' +
    '(4)1555-09-25 아우크스부르크 종교화의(Peace of Augsburg) — "각 영주가 자기 영지의 종교를 결정한다(cuius regio, eius religio)"를 ' +
    '마지못해 인정. 카를의 종교적 통일 시도는 결국 실패. ' +
    '\n\n' +
    '프랑스와의 4차 이탈리아 전쟁(1521~1544). 프랑스 발루아 가문(프랑수아 1세·앙리 2세)과 약 30년에 걸친 ' +
    '이탈리아 패권 다툼. (1)1525-02-24 파비아 전투(Battle of Pavia) — 프랑수아 1세를 직접 생포한 결정적 승리 ' +
    '(2)1527-05-06 로마 약탈(Sack of Rome) — 카를의 미지급 용병이 로마 약탈, 교황 클레멘스 7세를 포로로 ' +
    '(3)1529 캄브레 조약 (4)1544 크레피 조약. 결과는 카를의 이탈리아 패권 확립. ' +
    '\n\n' +
    '오스만 제국·바르바리 해적 대응. (1)1529 빈 1차 포위 — 술레이만 1세의 침공을 격퇴 ' +
    '(2)1535 튀니스 정복 — 바르바리 해적 거점 해체 (3)1541 알제 원정 실패. ' +
    '\n\n' +
    '신대륙 식민지. 카를 재위 중 (1)1519~1521 코르테스의 아즈텍 정복 (2)1532~1533 피사로의 잉카 정복 ' +
    '(3)1519~1522 마젤란-엘카노 함대 세계 일주(카를이 후원). 신대륙에서 약 16,000톤의 은이 본국으로 유입, ' +
    ...
    '합스부르크 가문이 (1)스페인 합스부르크(펠리페 2세 — 스페인·네덜란드·이탈리아·신대륙) ' +
    '(2)오스트리아 합스부르크(페르디난트 1세 — 신성로마·오스트리아·헝가리)로 분할. ' +
    '\n\n' +
    '1556~1558 유스테 은퇴. 1556-09 스페인 카스티야 유스테(Yuste) 산 헤로니모 수도원에 은퇴. ' +
    '약 2년간 시계 수집·기도·신학 토론으로 시간을 보냄. 통풍·말라리아로 1558-09-21 사망. ' +
    '\n\n' +
    '장기 유산. (1)스페인 합스부르크 시대(1556~1700)의 출발 (2)네덜란드 독립 전쟁(1568~1648)의 직접 도화선 — ' +
    '아들 펠리페 2세의 강경 가톨릭·과세 정책 (3)신대륙 식민지 약 320년 스페인 통치(1492~1898) 토대 ' +
    '(4)아우크스부르크 종교화의(1555)의 "영주 결정 종교" 원칙 — 베스트팔렌 조약(1648)·근대 국제법 토대 ' +
    '(5)"해가 지지 않는 제국" 개념 — 후일 대영제국 등에 차용.',
  influence: 95,
} as const
...
const HABSBURG_DYNASTY = {
  ...
  description:
    ...
    '1556년 카를 5세 분할 양위로 (1)스페인 합스부르크(1556~1700, 펠리페 2세 계열) ' +
    '(2)오스트리아 합스부르크(1556~1740, 페르디난트 1세 계열)로 분할. ' +
...
export async function seedCharlesV(prisma: PrismaService): Promise<void> {
  ...
  //  (1) 신성로마제국(HC start=962): 카를 5세는 962 오토 1세부터 20번째 황제 → 20대
  //  (2) 합스부르크령 네덜란드(HC start=1482): 부친 펠리페 1세(1대) 다음 → 2대
  //  (3) 카스티야 왕국(HC start=1230): 13대 후아나 1세 → 14대 펠리페 1세 → 15대 카를로스 1세
  //
  ...
  if (castileHC && kingPos) {
    ...
    //   (1) 공동(NULL) jure matris (1516~1555) — 어머니 후아나 1세와 명목 공동 통치
    //   (2) 14대 단독 (1555~1556) — 후아나 사망 후 약 9개월 단독 군주
    REIGNS.push({
