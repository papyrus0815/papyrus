 ...
 *  - SovereignReign x3:
 *      (1) 카스티야 왕국 국왕 16대 펠리페 2세 (1556-01-16 ~ 1598-09-13, DEATH_IN_OFFICE)
 *      (2) 합스부르크령 네덜란드 군주 3대 펠리페 2세 (1555-10-25 ~ 1581-07-26, REMOVAL — 단념 선언)
 *      (3) 포르투갈 왕국 국왕 18대 펠리페 1세 (1580-09-12 ~ 1598-09-13, DEATH_IN_OFFICE)
...
const FELIPE_II = {
  ...
  deathNote:
    ...
    '\n\n' +
    '병변 진행. (1)1597 말부터 무릎 통증·고열 반복 (2)1598-06 마드리드에서 엘 에스코리알로 ' +
    '50km 이동(약 1주일 소요, 들것 사용) (3)1598-07-22 도착 후 침대에 고정, 다리·복부에 ' +
    '거대한 종양성 욕창 다수 발생, 종양에서 화농·구더기 발생(동시기 기록) (4)의사들이 자세 변경을 ' +
    '시도했으나 통증·악취 때문에 약 50일 한 자세 유지 (5)1598-09-13 새벽 5시경 사망(향년 71세). ' +
    ...
    '(1)만성 통풍(podagra — 합스부르크 가문 유전) (2)전립선암 가능성(말년 배뇨 곤란·신장 결석 동반) ' +
    '(3)장기 누워있음에 의한 욕창성 농양 (4)패혈증으로 추정. 단일 사인보다 다중 합병증으로 평가.',
  biography:
    '합스부르크 가문 — 스페인 합스부르크의 2대 군주. 카를 5세(Carlos I)와 이사벨 데 포르투갈의 ' +
    '적장자. 신중왕(el Prudente)·욕망의 지배자(el Rey Burócrata) 별칭. ' +
    '재위 (1)카스티야·아라곤·이탈리아·신대륙(1556~1598) (2)합스부르크령 네덜란드(1555~1581) ' +
    '(3)포르투갈(1580~1598, 펠리페 1세 — 이베리아 연합) (4)잉글랜드 왕배(1554~1558, 메리 1세 결혼 기간) ' +
    '(5)밀라노 공국(1540~1598, 부친 양위) (6)나폴리·시칠리아·사르데냐 왕(1554/1556~1598). ' +
    '\n\n' +
    ...
    '\n\n' +
    '1555~1556 부친의 분할 양위로 즉위. (1)1555-10-25 브뤼셀에서 합스부르크령 네덜란드 양위 — 3대 펠리페 2세 즉위 ' +
    '(2)1556-01-16 카스티야·아라곤·나폴리·시칠리아·사르데냐·이탈리아·신대륙 양위 — 카스티야 16대 펠리페 2세 즉위 ' +
    '(3)1556-02-25 신성로마제국은 동생 페르디난트 1세에게 양위 — 합스부르크 가문이 스페인 합스부르크(펠리페 계열) + ' +
    '오스트리아 합스부르크(페르디난트 계열)로 분할. ' +
    '\n\n' +
    '1557~1559 프랑스 격파·이탈리아 평화. (1)1557-08-10 산 칸틴 전투(Battle of St. Quentin) — ' +
    '프랑스군 격파, 펠리페 2세는 이를 기념해 산 로렌소 성인의 축일에 "엘 에스코리알 수도원" 건립 시작(1563~1584) ' +
    '(2)1559-04-03 카토-캄브레지 조약(Treaty of Cateau-Cambrésis) — 약 65년에 걸친 이탈리아 전쟁(1494~) 종결, ' +
    '스페인의 이탈리아 패권 확립(나폴리·시칠리아·밀라노). ' +
    '\n\n' +
    '1559 엘리자베스 드 발루아와 결혼. 1559-06-22 카토-캄브레지 조약 결과 프랑스 앙리 2세의 딸 ' +
    '엘리자베스 드 발루아(Elisabeth of Valois, 1545~1568)와 결혼. 두 딸 — (1)이사벨라 클라라 에우헤니아 ' +
    '(Isabella Clara Eugenia, 1566~1633, 후일 합스부르크령 네덜란드 공동 군주) (2)카탈리나 미카엘라 ' +
    ...
    '결정적 이유는 (1)이베리아 반도 정중앙의 지리적 위치 (2)톨레도의 가톨릭 보수파 영향력 약화 ' +
    '(3)새 수도에서 본인의 절대왕정 행정 시스템 직접 구축. 마드리드 알카사르(현 왕궁 위치)에 ' +
    ...
    '동시기 공식 발표는 자연사였으나 (1)정신 이상 (2)네덜란드 반란군과 내통 시도 (3)부친에 대한 살해 음모 ' +
    ...
    '대응해 (1)1567 알바 공작(Duke of Alba) 파견·"피의 의회(Council of Troubles)"로 약 1,000명 처형 ' +
    '(2)1568-05 빌렘 1세(William of Orange)의 봉기로 80년 전쟁 발발 (3)1572 해상 거지(Watergeuzen)의 브릴(Brielle) 점령 ' +
    '(4)1576 안트베르펀 약탈(Spanish Fury) — 미지급 용병 약 7,000명의 시민 학살 (5)1579 위트레흐트 동맹(Union of Utrecht — ' +
    '북부 7개 주) (6)1581-07-26 단념 선언(Act of Abjuration) — 북부 7개 주가 펠리페 2세를 군주로 인정 거부. ' +
    ...
    '(1)80년 전쟁 (2)지중해 함대 유지 (3)잉글랜드 침공 (4)이탈리아 패권 유지 등의 군사 비용으로 ' +
    '재위 중 4번 국가 채무 불이행 선언. 푸거(Fugger)·벨저(Welser)·제노바 은행가 가문에 ' +
    '약 1억 두카토 누적 부채 — 부친 카를 5세부터 이어진 합스부르크 만성 재정난의 정점. ' +
    '\n\n' +
    '장기 유산. (1)스페인 합스부르크 약 144년(1556~1700) 기반 구축 (2)네덜란드 독립 전쟁(1568~1648)의 ' +
    '직접 도화선 (3)이베리아 연합(1580~1640)으로 일시적이지만 사상 최대 식민제국 형성 ' +
    '(4)마드리드 천도(1561) — 현대 스페인 수도의 출발 (5)엘 에스코리알(1584) — 스페인 가톨릭 절대왕정의 건축적 상징 ' +
    '(6)레판토 해전(1571) + 무적함대(1588) — 가톨릭/개신교 세력 균형 변화의 결정적 두 사건의 주역.',
  influence: 92,
} as const
...
const ISABEL_OF_PORTUGAL = {
  ...
  deathNote:
    ...
    '\n\n' +
    '사후 영향. (1)티치아노(Titian)가 이사벨 사후 1545년경 "이사벨 황후의 초상화"를 회화 ' +
    '— 21세기 현재 마드리드 프라도 미술관 소장. 이 그림은 펠리페 2세가 평생 침실에 두었던 ' +
    '어머니의 유일한 모습 (2)카를 5세는 1556 양위·은퇴 후에도 재혼하지 않고 미망인으로 사망(이사벨에 대한 추모) ' +
    '(3)펠리페 2세의 4번 결혼 중 첫 번째 부인 마리아 마누엘라가 어머니 이사벨의 조카로 — ' +
  ...
  biography:
    ...
    '\n\n' +
    '6명의 자녀. (1)페르난도(1529, 사산) (2)펠리페(후일 펠리페 2세, 1527-05-21~1598) ' +
    '(3)마리아(Maria, 1528~1603 — 후일 신성로마황후) (4)후아나(Joanna, 1535~1573 — 포르투갈 왕배) ' +
    '(5)사산아(1534) (6)사산아(1539-04 — 본인 사망 직전). 6명 중 성인까지 생존한 자녀는 3명. ' +
    '\n\n' +
    '1539 사망. 1539-04 7번째 임신 도중 사산이 시작, 약 2주간 출혈·발열로 35세에 사망. ' +
    '카를 5세는 평생 재혼하지 않고 미망인으로 1558 사망. ' +
    '\n\n' +
    '장기 유산. (1)펠리페 2세의 어머니로서 후일 합스부르크 스페인 절대왕정의 행정 모델 직접 영향 ' +
    '(2)티치아노 작 "이사벨 황후의 초상화(1545년경)" — 16세기 여성 초상화의 걸작 ' +
    '(3)1526 결혼이 카를 5세-아비스 왕가 동맹의 시작 → 1580 펠리페 2세의 포르투갈 왕위 계승의 ' +
...
const AVIZ_DYNASTY = {
  ...
  description:
    ...
    '15세기 "대항해 시대"의 직접 후원 가문 — (1)엔히크 항해왕자(Infante Henrique, 1394~1460)의 ' +
    '항해 학교 (2)바스쿠 다 가마의 인도 항로 개척(1497~1499) (3)페드루 알바르스 카브랄의 브라질 발견(1500) ' +
    '(4)아폰수 데 알부케르키의 인도 고아·말라카·호르무즈 점령(1510~1515) — 약 200년에 걸친 ' +
...
const PORTUGAL_HC_SPEC = {
  ...
  description:
    ...
    '15~16세기 대항해 시대를 주도해 (1)1488 바르톨로메우 디아스의 희망봉 도착 (2)1497~1499 바스쿠 다 가마의 ' +
    '인도 항로 개척 (3)1500 페드루 알바르스 카브랄의 브라질 발견 (4)1510~1515 인도 고아·말라카·호르무즈 점령으로 ' +
...
export async function seedFelipeII(prisma: PrismaService): Promise<void> {
  ...
  const DYNASTY_RULES: DynastyRuleSpec[] = [
    // (1) 합스부르크 → 카스티야 왕국 (1516 카를로스 1세 즉위 ~ 1700 카를로스 2세 사망)
    {
    ...
    // (3) 합스부르크 → 포르투갈 왕국 (1580 펠리페 1세 즉위 ~ 1640 포르투갈 왕정복고 전쟁)
    {
      dynastyId: habsburgDynasty.id,
      dynastyName: '합스부르크 가문',
      historicalCountryId: portugalHC.id,
  ...
  if (kingPos) {
    REIGNS.push({
      ...
      notes:
        ...
        '재위 중 (1)1561 마드리드 천도 (2)1571 레판토 해전 (3)1580 이베리아 연합(포르투갈 합병) ' +
        '(4)1584 엘 에스코리알 완공 (5)1588 무적함대 패배 (6)4번의 국가 부도(1557·1560·1575·1596) 등 ' +
  ...
  // (3) 포르투갈 왕국 18대 펠리페 1세 (이베리아 연합 시작)
  ...
  if (portugalHC && kingPos) {
    REIGNS.push({
      ...
      notes:
        ...
        '단 (1)포르투갈 의회·법·통화·언어·식민지 행정 별도 유지 (2)포르투갈인만 포르투갈 식민지 관직 임명 ' +
        '(3)브라질·인도·아프리카 식민제국 그대로 유지 등 "동군연합(Personal Union)" 형태 보장. ' +
