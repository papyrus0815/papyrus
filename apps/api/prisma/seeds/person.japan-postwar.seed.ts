...
<ul>
  ...
  },
  {
    ...
    aftermath:
      'GHQ 통치 하에서 다음의 대개혁이 단행되었다 — (1) 군대 해산·군국주의자 공직추방, (2) 신헌법 제정(1946-47), (3) 농지개혁(1946-50), (4) 재벌 해체, (5) 노동조합 합법화·노동기준법(1947), (6) 교육개혁(1947-48), (7) 극동국제군사재판(1946-48). 1952년 4월 28일 샌프란시스코 강화조약 발효로 일본은 주권을 회복하고 점령이 종료되었다.',
...
<p>천황은 "국가와 국민통합의 상징"이 되어 정치적 권능을 잃고 의례적 행위만 수행한다(상징천황제, 1~7조).</p>`,
  ...
  },
  {
    ...
    aftermath:
      '신헌법 시행에 따라 (1) 11개 황족 가문이 황적이탈(臣籍降下), (2) 귀족원이 폐지되고 참의원이 설치되었으며, (3) 추밀원·내대신부·궁내성 등 구 헌법 기관이 폐지되었다. 5월 20일 신헌법 하 첫 국회 개회, 5월 23일 가타야마 데쓰가 국회 지명을 통해 총리로 선출되어 5월 24일 내각을 발족시켰다.',
