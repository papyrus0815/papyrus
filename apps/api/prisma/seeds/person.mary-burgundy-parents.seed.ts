...
const CHARLES_BOLD = {
  ...
  biography:
    ...
    '1467년 6월 15일 부친 선량공 필리프 3세 사망으로 부르고뉴 공작으로 즉위했다. 약 9년 6개월 재위. 그의 통치는 동시기 유럽에서 가장 야심찬 영토 확장 정책으로 알려졌다. 부르고뉴 공국·플랑드르·브라반트·홀란트·룩셈부르크 등 약 250만 km²를 통합한 부르고뉴 국가(Burgundian State)를 신성로마와 프랑스 사이의 결정적 강대국으로 만들기 위해 (1)로렌 공국 정복(부르고뉴 본토와 저지대 영지 사이의 지리적 통합) (2)스위스 동맹 격파 (3)알자스·라인 지역 확장 등을 시도했다.\n\n' +
    ...
    '1474년부터 시작된 부르고뉴 전쟁(Burgundian Wars)에서 (1)1474 헤리쿠르 전투 패배 (2)1476 그랑송 전투 대패(스위스 동맹) (3)1476 모라 전투 결정적 패배(스위스 동맹)로 연속 군사 패전을 겪었다. 1477년 1월 5일 낭시(Nancy)에서 로렌 공작 르네 2세와 스위스 동맹 군대를 상대로 마지막 전투를 시도했다. 약 12,000명의 부르고뉴 군대 vs 약 19,000명의 로렌-스위스 연합군. 결과는 결정적 패배 — 샤를은 전투 중 머리에 미늘창(halberd) 일격으로 향년 43세에 전사했다.\n\n' +
