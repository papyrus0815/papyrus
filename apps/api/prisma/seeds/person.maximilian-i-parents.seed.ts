...
const FRIEDRICH_III = {
  ...
  biography:
    ...
    '프리드리히 3세의 유산은 합스부르크 가문 권력의 결정적 토대였다. ①약 53년 재위로 합스부르크 가문이 신성로마황제 자리를 "사실상 세습"하는 관행 정착 ②1473년 부르고뉴 결혼 약속 → 1477 막시밀리안-마리 결혼 → 합스부르크령 네덜란드 상속 ③모토 AEIOU의 합스부르크 세계관 정립 ④교황 대관을 받은 마지막 황제로서 신성로마 권위의 중세적 정점.',
  influence: 80,
  stats: {
    politics: 70,
    military: 50,
