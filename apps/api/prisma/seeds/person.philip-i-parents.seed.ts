 ...
 *  - SovereignReign x2:
 *      ① 막시밀리안 1세 — 신성로마제국 황제 19대 (1493-08-19 ~ 1519-01-12, DEATH_IN_OFFICE)
 *      ② 부르고뉴 마리 — 부르고뉴 공국 공작 5대 (1477-01-05 ~ 1482-03-27, DEATH_IN_OFFICE)
 *
...
const VALOIS_BURGUNDY_DYNASTY = {
  ...
  description:
    ...
    '①필리프 2세(1363~1404, "담대공 필리프(Philip the Bold)") ②장 1세(1404~1419, "공포공 장(John the Fearless)") ' +
    '③필리프 3세(1419~1467, "선량공 필리프(Philip the Good)") ④샤를 1세(1467~1477, "담대공 샤를(Charles the Bold)") ' +
    '⑤마리 1세(1477~1482) — 5대 약 119년에 걸쳐 ' +
...
const BURGUNDY_HC_SPEC = {
  ...
  description:
    ...
    '①디종 중심의 부르고뉴 공국 본토 ②플랑드르·아르투아·브라반트·홀란트·룩셈부르크 등 저지대 영지 ' +
    '③니베르네·샤롤레 등 추가 영지를 통합한 〈부르고뉴 국가(Burgundian State)〉는 약 100년에 걸쳐 ' +
    ...
    '1477-01-05 샤를 1세 전사·1482-03-27 마리 1세 사망 후 ①본토(디종) → 1482-12-23 아라스 조약(Treaty of Arras)으로 프랑스 합병 ' +
    '②저지대 영지 → 합스부르크 가문에 상속 〈합스부르크령 네덜란드〉로 분리. 약 450년의 부르고뉴 공국이 ' +
...
const MAXIMILIAN_I = {
  ...
  deathNote:
    ...
    '\n\n' +
    '【매장】 본인의 유언에 따라 시신 두 부분으로 분리 — ①심장은 부인 부르고뉴 마리의 시신 옆 ' +
    '벨기에 브뤼주(Brugge) 〈성모성당(Onze-Lieve-Vrouwekerk)〉에 안치 ②몸은 자신이 평생 사랑한 도시 ' +
    '빈 노이슈타트(Wiener Neustadt)의 〈성 게오르크 성당(St. Georgskathedrale)〉 제단 아래에 안치. ' +
    '21세기 현재 두 곳 모두 보존. ' +
    '\n\n' +
    '【사후 영향】 ①손자 카를 5세가 1519-06-28 신성로마황제 선출 — 푸거 가문 차입 약 200만 두카토로 ' +
    '7 선제후 매수 ②합스부르크 가문이 신성로마·합스부르크령 네덜란드·오스트리아·카스티야·아라곤·신대륙 ' +
  ...
  biography:
    ...
    '라는 합스부르크 격언이 막시밀리안의 외교 전략을 압축. ①본인 — 1477 부르고뉴 마리(저지대 영지) ' +
    '②아들 펠리페 1세 — 1496 카스티야 후아나 1세(스페인·신대륙) ③손자 카를 5세 — 1526 포르투갈 이사벨 ' +
    '④손녀 마리아 — 1521 헝가리 라요시 2세(헝가리·보헤미아) — 4대에 걸친 결혼 외교로 합스부르크 가문 ' +
    '영토 폭증의 직접 설계자. ' +
    '\n\n' +
    '【1494~1559 이탈리아 전쟁의 시작】 ' +
    '1494 프랑스 샤를 8세의 이탈리아 침공으로 약 65년 이탈리아 전쟁 발발. 막시밀리안은 ①1495 신성동맹 ' +
    '결성으로 프랑스 봉쇄 ②1499 스위스 독립 전쟁 패배(슈바벤 전쟁 — 스바벤 동맹 격파) ③1508 캄브레 ' +
    '동맹으로 베네치아 견제 등 약 25년 이탈리아 전쟁 직접 지휘. 단 결정적 승리 없이 외교적 균형 유지. ' +
    '\n\n' +
    '【1495 보름스 의회 — 〈영원한 평화령(Ewiger Landfriede)〉】 ' +
    '1495 보름스 의회에서 ①〈영원한 평화령〉으로 신성로마제국 영방 간 사적 무력 분쟁 금지 ' +
    '②제국 의회(Reichstag) 정비 ③Reichskammergericht(제국 최고법원) 설치 ④제국 세금(공통 페니히) 도입 시도 ' +
    ...
    '①알브레히트 뒤러(Albrecht Dürer)의 후원자 — 1518 〈막시밀리안 1세 초상화〉 의뢰 ②〈Theuerdank(1517)〉 ' +
    '〈Weisskunig〉 등 자전적 서사시 의뢰 — 본인이 등장하는 르네상스 알레고리 ③개인 갑옷 수집·기사 토너먼트 ' +
    '직접 참여 등으로 중세 기사도와 르네상스 학예의 중간 위치 — 〈최후의 기사(Der letzte Ritter)〉 별칭. ' +
    '\n\n' +
    '【장기 유산】 ①합스부르크 결혼 정책 → 카를 5세의 4중 상속 → 16세기 합스부르크 유럽 패권 ' +
    '②1495 〈영원한 평화령〉·Reichskammergericht로 신성로마제국 〈제국 개혁〉의 출발 ③1508 〈선출 황제〉 ' +
    '칭호 모델 — 후일 모든 신성로마황제가 채용 ④손자 카를 5세를 신성로마·스페인 동시 군주로 만든 직접 설계자.',
  influence: 88,
  stats: {
    politics: 80,
    military: 70,
...
const MARY_BURGUNDY = {
  ...
  deathNote:
    ...
    '\n\n' +
    '【사후 영향】 ①4세의 펠리페 1세가 부르고뉴 영지(저지대 + 디종 본토) 상속 → 약 1년 후 ' +
    '1482-12-23 〈아라스 조약(Treaty of Arras)〉으로 본토(디종)는 프랑스 합병, 저지대 영지만 ' +
    '합스부르크 가문이 유지 〈합스부르크령 네덜란드(1482~1581)〉로 정식 출발 ②막시밀리안이 ' +
    '약 11년 펠리페 1세 섭정(1482~1493) ③5명의 자녀 중 펠리페·마르가레타 2명만 성인 생존 ' +
    '— 제3 자녀 프란츠는 1481 출생 직후 사망, 마리 사후 태아도 사망 ④부르고뉴 직계 단절. ' +
    '\n\n' +
    '【문학적 신화화】 마리의 낙마·25세 요절은 동시기·후대 시·소설·회화의 결정적 소재 — ' +
    '①후일 〈오라네어 빌헬무스(Wilhelmus van Nassouwe — 네덜란드 국가)〉의 멜로디 출처가 부르고뉴 시대 노래 ' +
    '②16~17세기 회화에 마리·막시밀리안의 결혼 장면이 합스부르크 영광의 출발로 반복 묘사 ③낭만주의 시대 ' +
  ...
  biography:
    ...
    '①플랑드르·브라반트·홀란트 등 부르고뉴 저지대 도시·영방의 자치권·세금 인하·언어권 인정 ' +
    '②부르고뉴 공작의 사적 군대 사용 제한 ③화폐 발행 영방 공동 관리 — 사실상 부르고뉴 권력의 ' +
    '결정적 약화. 마리가 〈대특권〉을 발포한 이유는 ①부친 샤를 1세 사망 후 즉위 정당성 위기 ②프랑스 ' +
    ...
    '①부친 신하·궁정 의회의 권유 ②막시밀리안의 인품·외모 호감으로 합스부르크 막시밀리안과 결혼 결정. ' +
    ...
    '\n\n' +
    '【1477~1482 약 5년 통치】 ' +
    '결혼 직후부터 ①프랑스 루이 11세의 디종 합병 시도 차단 ②플랑드르 도시 반란(헨트·브뤼주 등) 진정 ' +
    '③〈대특권〉 후속 행정 개혁 등 약 5년간 마리·막시밀리안 부부가 부르고뉴 통치. 5명의 자녀 출산 — ' +
    '①펠리페 1세(1478, 후일 미남공 필리프) ②프랑수아(1481, 신생아 사망) ③마르가레타(1480, 후일 ' +
    '카스티야 후아나 1세 양모·합스부르크령 네덜란드 섭정 1507~1530) ④사산아(1482, 본인 사망 시) ' +
    '⑤사산아(1481경). 5명 중 성인 생존 2명. ' +
    '\n\n' +
    ...
    '\n\n' +
    '【장기 유산】 ①약 5년 단독 통치였으나 1477 〈대특권〉으로 저지대 자치 전통 정립 → 1568 80년 ' +
    '전쟁의 사상적 토대 ②합스부르크 가문이 부르고뉴 저지대 영지를 상속 → 1482 〈합스부르크령 네덜란드〉 ' +
    '출발 → 16세기 합스부르크 유럽 패권의 한 축 ③아들 미남공 필리프 → 후아나 1세 결혼 → 카를 5세 → ' +
    '카스티야·아라곤·신성로마·합스부르크령 네덜란드 4중 상속 → 16세기 사상 최대 영토 군주의 출발 ' +
    '④딸 마르가레타 → 합스부르크령 네덜란드 섭정(1507~1530) → 어린 카를 5세 양육의 직접 양모 ' +
    '⑤브뤼주 〈성모성당〉의 청동 묘상은 15세기 후반 부르고뉴 미술의 정점.',
  influence: 75,
  stats: {
    politics: 70,
    military: 30,
  ...
  if (hrePos) {
    REIGNS.push({
      ...
      notes:
        ...
        '약 26년 재위 중 ①1495 보름스 의회 〈영원한 평화령〉·Reichskammergericht 설치 ②1499 슈바벤 전쟁 ' +
        '③합스부르크 결혼 정책 4대 설계 ④1494~ 이탈리아 전쟁 직접 지휘 ⑤알브레히트 뒤러 등 르네상스 후원. ' +
  ...
  if (dukePos) {
    REIGNS.push({
      ...
      notes:
        ...
        '차단·합스부르크와 동맹. 약 5년 통치 중 ①〈대특권〉 이행 ②플랑드르 도시 반란 진정 ③프랑스의 ' +
