 ...
 *
 * `view`는 라우트에서 prop으로 주입 — pathname 재파싱(이전 `deriveView`) 제거.
 */
...
export type TimelineSimpleView = Extract<
  DashboardContentView,
  'ethnicity' | 'legislature' | 'military'
>

interface Props {
  view: TimelineSimpleView
}

export default function TimelineViewPage({ view }: Props) {
