/**
 * 전역 수반(교황 등) 섹션 — 국가에 속하지 않는 직책 등록·관리
 * 행정 수반 대시보드 메뉴에서 사용
 * 디자인: 전체 사건(events-timeline-section) 참조
 */
...
import { PersonSelectField } from '@/shared/ui/form-fields'
        ...
        {isLoading && tenures.length === 0 ? (
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              ...
              <EmptyDesc>
                위 <strong style={{ color: '#475569', fontWeight: 600 }}>전역 수반 등록</strong> 버튼을 눌러 교황 등을 추가하세요.
              </EmptyDesc>
            </div>
          </EmptyState>
        ) : (
